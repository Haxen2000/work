getPlayerImageUrl = function(team, player, size) {
	...
	for (var i = 0; i < teams[team].lineup.length; i++) {
		if (teams[team].lineup[i].gamerTag == player && teams[team].lineup[i].photoUrl && imgType == '.png') {
	...
	return "http://cdn.eleague.com/img/csgo/premier/" + slug + "/" + player.toLowerCase() + "_" + size + imgType;
}
...
G2 = {
	...
	"lineup" 	: 	[
		...
		},
		{
			...
			"socialLink"	: "@nV_NBK",
			"videoLink"		: 'nbk',
			"teamPhotoUrl"	: 'http://cdn.eleague.com/img/csgo/premier/g2/nbk-_177x222.jpg',
			id 				: 213552
		},
		{
			"faceitID"		: "de21905f-47e9-46c2-bfd2-e56f63795c87",
